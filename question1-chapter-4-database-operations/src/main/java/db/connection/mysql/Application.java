		...
		while(true) {
			...
			switch (choice) {
				...
				case 7:
					...
					showActiveManager(managerService);
					System.out.println();
					break;
				case 8:
...
public static void showAllDepartments(DepartmentService departmentService) {
	...
	System.out.println("Departman isimleri");
	System.out.println("******************");
	for (Department dpt : department) {
			System.out.println(dpt.getName());}
	}

public static void showActiveManager(ManagerService managerService) {
	
	List<Manager> manager = managerService.loadAllActiveManagers();
	
	System.out.println("Aktif yönetici bilgileri");
	System.out.println("***********************");
	for (Manager mng : manager) {
			System.out.println(mng.getEmployee().getName()+" - "+mng.getDepartmentName());}
	}
